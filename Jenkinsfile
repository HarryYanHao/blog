...
pipeline {
    ...
    parameters {
        ...
        gitParameter name: 'GIT_REF', type: 'PT_TAG_AND_BRANCH', tagFilter: '*',branchFilter: 'origin/(.*)',branch: '', tagFilter: '*', defaultValue: 'master', sortMode: 'DESCENDING_SMART', selectedValue: 'DEFAULT', quickFilterEnabled: false
    }
    environment {
        // 目标服务器信息
        SERVER_USER = 'root'
