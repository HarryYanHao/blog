...
pipeline {
    ...
    parameters {
        ...
        gitParameter name: 'GIT_TAG_BRANCH', type: 'PT_BRANCH_TAG', branchFilter: 'origin/(.*)',branch: '', tagFilter: '*', defaultValue: 'master', sortMode: 'DESCENDING_SMART', selectedValue: 'DEFAULT', quickFilterEnabled: false
    }
    environment {
        // 目标服务器信息
        SERVER_USER = 'root'
